...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  9 21:47:18 2025
...
path_mango = "basketball.jpeg"
path_strawberry = "soccer_ball.jpg"
...
print(f'soccerball shape: {strawberry.shape}')
print(f'basketball shape: {mango.shape}')
...
print(f'downsample shape: {downsample.shape}')
'''
...
def reconstructImage(residuals, downsample):
    ...
    for residual in residuals:
        ...
        upsample = cv2.resize(downsample, None, fx=2, fy=2, interpolation=cv2.INTER_CUBIC)
        upsample = cv2.GaussianBlur(upsample, kernel, sigma)
...
mask_pyramid = computeGaussianPyramid(mask, 4)
...
blended_residuals = []
mango_residuals, mango_downsample = computeLaplacianPyramid(mango, 4)
